...
namespace Applications\Core\Admin\Packages\AdminLTETags\Tags\Content\Listing\Table;

use Applications\Core\Admin\Packages\AdminLTETags\AdminLTETags;
use Applications\Core\Admin\Packages\AdminLTETags\Tags\Content\Listing\Filters;
...
class DynamicTable
{
    ...
    // protected function inclRowsJs($rowsData)
    // {
    //     return
    //         "<script>
    //             window['dataCollection']['" . $this->params["componentId"] . "']['" . $this->params["componentId"] . "-" . $this->params["sectionId"] . "']['listOptions']['datatable'] =
    //             $.extend(window['dataCollection']['" . $this->params["componentId"] . "']['" . $this->params["componentId"] . "-" . $this->params["sectionId"] . "']['listOptions']['datatable'], {
    //                 'data'                              : JSON.parse('" . Json::encode($rowsData) . "'),
    //                 'pagination'                        : '" . $this->params["dtPagination"] . "',
    //                 'rowControls'                       : '" . $this->params["dtRowControls"] . "',
    //                 'replaceColumns'                    : JSON.parse('" . Json::encode($this->params["dtReplaceColumns"]) . "')
    //             });
    //         </script>";
    // }
}