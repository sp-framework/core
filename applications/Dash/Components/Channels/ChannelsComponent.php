...
namespace Applications\Dash\Components\Channels;

use Applications\Dash\Packages\AdminLTETags\Traits\DynamicTable;
use Applications\Dash\Packages\Channels\Channels;
use Applications\Dash\Packages\Locations\Model\Locations;
...
class ChannelsComponent extends BaseComponent
{
    ...
    {
        // $locations = $this->modelsManager->executeQuery('SELECT * FROM Applications\Dash\Packages\Locations\Model\Locations');
