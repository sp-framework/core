...
namespace Applications\Dash\Components\Filters\Install;

use Applications\Dash\Components\Filters\FiltersComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/applications/Dash/Components/Filters/';
