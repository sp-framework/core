...
namespace Applications\Dash\Components\Hrms\Employees\Settings\Designations\Install;

use Applications\Dash\Components\Hrms\Employees\Settings\Designations\DesignationsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(DesignationsComponent::class)) {
    ...
    {
        $componentPath = '/applications/Dash/Components/Hrms/Employees/Settings/Designations';
