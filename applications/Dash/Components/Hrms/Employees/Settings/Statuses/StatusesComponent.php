...
namespace Applications\Dash\Components\Hrms\Employees\Settings\Statuses;
...
class StatusesComponent extends BaseComponent
{
    ...
    public function viewAction()
    {
        ...
        $controlActions =
            [
                'actionsToEnable'       =>
                [
                    'edit'      => 'hrms/employees/settings/statuses',
                    'remove'    => 'hrms/employees/settings/statuses/remove'
                ]
            ];

        $this->generateDTContent(
            $this->statuses,
            'hrms/employees/settings/statuses/view',
            null,
            ['name'],
            false,
            ['name'],
    ...
    public function addAction()
    {
        if ($this->request->isPost()) {
            ...
            $this->statuses->addEmployeesStatus($this->postData());
    ...
    public function updateAction()
    {
        if ($this->request->isPost()) {
            ...
            $this->statuses->updateEmployeesStatus($this->postData());
    ...
    public function removeAction()
    {
        if ($this->request->isPost()) {
            ...
            $this->statuses->removeEmployeesStatus($this->postData());
