...
namespace Applications\Dash\Components\Hrms\Skills\Install;

use Applications\Dash\Components\Hrms\Skills\SkillsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/applications/Dash/Components/Hrms/Skills/';
    ...
    protected function registerMenu($menu)
    {
        ...
        $menu['applications'] =
                Json::encode([$this->application['id']=>['enabled'=>true]]);
