...
namespace Applications\Dash\Components\Ims\Brands\Install;

use Applications\Dash\Components\Ims\Brands\BrandsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/applications/Dash/Components/Ims/Brands/';
