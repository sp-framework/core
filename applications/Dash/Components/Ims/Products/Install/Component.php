...
namespace Applications\Dash\Components\Ims\Products\Install;

use Applications\Dash\Components\Ims\Products\ProductsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(ProductsComponent::class)) {
    ...
    {
        $componentPath = '/applications/Dash/Components/Ims/Products/';
