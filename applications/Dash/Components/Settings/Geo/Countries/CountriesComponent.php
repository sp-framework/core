...
namespace Applications\Dash\Components\Settings\Geo\Countries;
...
class CountriesComponent extends BaseComponent
{
    ...
    public function viewAction()
    {
        ...
        //                 'title'     => 'states',
        //                 'icon'      => 'map-marked',
        //                 'link'      => $this->links->url('settings/geo/q/type/states')
        //             ],
        //             'cities'    => [
        //                 'title'     => 'cities',
        //                 'icon'      => 'map-marked-alt',
        //                 'link'      => $this->links->url('settings/geo/q/type/cities')
        //             ]
        //         ]
        //     ];
