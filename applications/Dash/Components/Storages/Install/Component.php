...
namespace Applications\Dash\Components\Storages\Install;

use Applications\Dash\Components\Storages\StoragesComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/applications/Ecom/Dash/Components/Storages/';
