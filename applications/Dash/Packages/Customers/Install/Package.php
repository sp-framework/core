...
namespace Applications\Dash\Packages\Customers\Install;

use Applications\Dash\Packages\Customers\Customers;
use Applications\Dash\Packages\Customers\Install\Schema\Customers as CustomersSchema;
...
class Package extends BasePackage
{
    ...
    {
        $packagePath = '/applications/Ecom/Dash/Packages/Customers/';
