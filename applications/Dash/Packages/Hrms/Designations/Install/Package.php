...
namespace Applications\Dash\Packages\Hrms\Designations\Install;

use Applications\Dash\Packages\Hrms\Designations\HrmsDesignations;
use Applications\Dash\Packages\Hrms\Designations\Install\Schema\HrmsDesignations as HrmsDesignationsSchema;
use Phalcon\Helper\Json;
use System\Base\BasePackage;

class Package extends BasePackage
{
    protected $schemaToUse = HrmsDesignationsSchema::class;

    protected $packageToUse = HrmsDesignations::class;
    ...
    public function installPackage(bool $dropTables = false)
    {
        ...
        try {
            if ($dropTables) {
                $this->createTable('hrms_designations', '', (new $this->schemaToUse)->columns(), $dropTables);
            } else {
                $this->createTable('hrms_designations', '', (new $this->schemaToUse)->columns());
            }
    ...
    {
        $packagePath = '/applications/Dash/Packages/Hrms/Designations';
