...
namespace Applications\Dash\Packages\Hrms\Employees\Settings\Designations\Install;

use Applications\Dash\Packages\Hrms\Employees\Settings\Designations\EmployeesDesignations;
use Applications\Dash\Packages\Hrms\Employees\Settings\Designations\Install\Schema\EmployeesDesignations as EmployeesDesignationsSchema;
use Phalcon\Helper\Json;
use System\Base\BasePackage;

class Package extends BasePackage
{
    protected $schemaToUse = EmployeesDesignationsSchema::class;

    protected $packageToUse = EmployeesDesignations::class;
    ...
    public function installPackage(bool $dropTables = false)
    {
        ...
        try {
            if ($dropTables) {
                $this->createTable('hrms_employees_designations', '', (new $this->schemaToUse)->columns(), $dropTables);
            } else {
                $this->createTable('hrms_employees_designations', '', (new $this->schemaToUse)->columns());
            }
    ...
    {
        $packagePath = '/applications/Dash/Packages/Hrms/Employees/Settings/Designations';
