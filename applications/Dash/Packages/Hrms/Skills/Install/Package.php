...
namespace Applications\Dash\Packages\Hrms\Skills\Install;

use Applications\Dash\Packages\Hrms\Skills\Skills;
use Applications\Dash\Packages\Hrms\Skills\Install\Schema\Skills as SkillsSchema;
...
class Package extends BasePackage
{
    ...
    {
        $packagePath = '/applications/Dash/Packages/Hrms/Skills/';
