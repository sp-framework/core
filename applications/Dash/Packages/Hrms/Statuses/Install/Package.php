...
namespace Applications\Dash\Packages\Hrms\Statuses\Install;

use Applications\Dash\Packages\Hrms\Statuses\HrmsStatuses;
use Applications\Dash\Packages\Hrms\Statuses\Install\Schema\HrmsStatuses as HrmsStatusesSchema;
...
class Package extends BasePackage
{
    ...
    {
        $packagePath = '/applications/Dash/Packages/Hrms/Statuses';
