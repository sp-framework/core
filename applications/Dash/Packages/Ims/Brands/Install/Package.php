...
namespace Applications\Dash\Packages\Ims\Brands\Install;

use Applications\Dash\Packages\Ims\Brands\Brands;
use Applications\Dash\Packages\Ims\Brands\Install\Schema\Brands as BrandsSchema;
...
class Package extends BasePackage
{
    ...
    {
        $packagePath = '/applications/Dash/Packages/Ims/Brands/';
