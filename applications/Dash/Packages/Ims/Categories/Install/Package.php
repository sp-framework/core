...
namespace Applications\Dash\Packages\Ims\Categories\Install;

use Applications\Dash\Packages\Ims\Categories\Categories;
use Applications\Dash\Packages\Ims\Categories\Install\Schema\Categories as CategoriesSchema;
...
class Package extends BasePackage
{
    ...
    public function installPackage(bool $dropTables = false)
    {
        ...
        try {
            if ($dropTables) {
                $this->createTable('ims_categories', '', (new $this->schemaToUse)->columns(), $dropTables);
            } else {
                $this->createTable('ims_categories', '', (new $this->schemaToUse)->columns());
            }
    ...
    {
        $packagePath = '/applications/Dash/Packages/Ims/Categories/';
