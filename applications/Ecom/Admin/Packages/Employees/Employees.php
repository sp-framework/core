...
namespace Applications\Ecom\Admin\Packages\Employees;

use Applications\Ecom\Admin\Packages\Employees\Model\Employees as EmployeesModel;
...
class Employees extends BasePackage
{
    ...
    public function addProductCount(int $id)
    {
        ...
        if ($employee['product_count'] && $employee['product_count'] != '') {
            $employee['product_count'] = (int) $employee['product_count'] + 1;
        } else {
            $employee['product_count'] = 1;
        }
