...
namespace Applications\Ecom\Common\Packages\AdminLTETags\Tags;
...
class Buttons extends AdminLTETags
{
    ...
    protected function generateContent()
    {
        ...
        try {
            $button = 'Applications\\Ecom\\Common\\Packages\\AdminLTETags\\Tags\\Buttons\\' . ucfirst($this->params['buttonType']);
