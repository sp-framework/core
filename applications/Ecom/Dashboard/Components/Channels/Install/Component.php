...
namespace Applications\Ecom\Dashboard\Components\Channels\Install;

use Applications\Ecom\Dashboard\Components\Channels\ChannelsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(ChannelsComponent::class)) {
    ...
    {
        $componentPath = '/applications/Ecom/Dashboard/Components/Channels/';
