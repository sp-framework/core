...
namespace Applications\Ecom\Dashboard\Components\Filters\Install;

use Applications\Ecom\Dashboard\Components\Filters\FiltersComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(FiltersComponent::class)) {
    ...
    {
        $componentPath = '/applications/Ecom/Dashboard/Components/Filters/';
