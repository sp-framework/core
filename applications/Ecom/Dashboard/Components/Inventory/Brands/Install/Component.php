...
namespace Applications\Ecom\Dashboard\Components\Inventory\Brands\Install;

use Applications\Ecom\Dashboard\Components\Inventory\Brands\BrandsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(BrandsComponent::class)) {
    ...
    {
        $componentPath = '/applications/Ecom/Dashboard/Components/Inventory/Brands/';
