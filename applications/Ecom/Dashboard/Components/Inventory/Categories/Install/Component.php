...
namespace Applications\Ecom\Dashboard\Components\Inventory\Categories\Install;

use Applications\Ecom\Dashboard\Components\Inventory\Categories\CategoriesComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(CategoriesComponent::class)) {
    ...
    {
        $componentPath = '/applications/Ecom/Dashboard/Components/Inventory/Categories/';
