...
namespace Applications\Ecom\Dashboard\Components\Inventory\Specifications\Install;

use Applications\Ecom\Dashboard\Components\Inventory\Specifications\SpecificationsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(SpecificationsComponent::class)) {
    ...
    {
        $componentPath = '/applications/Ecom/Dashboard/Components/Inventory/Specifications/';
        ...
        [
            ...
            'menu'                  =>
                ...
                false,
            'applications'          =>
                Json::encode([$this->application['id']=>['installed'=>true,'menu_id'=>$menu['id']]]),
            'files'                 => Json::encode($this->getInstalledFiles($componentPath))
        ];

        $this->modules->components->add($component);
        $this->logger->log->info('Component ' . $component['name'] . ' installed successfully on application ' . $this->application['name']);
    }
    ...
    protected function registerMenu($menu)
    {
        ...
        $menu['application_id'] = $this->application['id'];
