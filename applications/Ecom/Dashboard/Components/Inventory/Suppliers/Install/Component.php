...
namespace Applications\Ecom\Dashboard\Components\Inventory\Suppliers\Install;

use Applications\Ecom\Dashboard\Components\Inventory\Suppliers\SuppliersComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(SuppliersComponent::class)) {
    ...
    {
        $componentPath = '/applications/Ecom/Dashboard/Components/Inventory/Suppliers/';
