...
namespace Applications\Ecom\Dashboard\Components\Storages\Install;

use Applications\Ecom\Dashboard\Components\Storages\StoragesComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(StoragesComponent::class)) {
    ...
    {
        $componentPath = '/applications/Ecom/Dashboard/Components/Storages/';
        ...
        [
            ...
            'menu'                  =>
                ...
                false,
            'applications'          =>
                Json::encode([$this->application['id']=>['installed'=>true,'menu_id'=>false]]),
