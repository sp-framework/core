...
namespace Applications\Ecom\Dashboard\Packages\Inventory\Suppliers\Install;

use Applications\Ecom\Dashboard\Packages\Inventory\Suppliers\Suppliers;
use Applications\Ecom\Dashboard\Packages\Inventory\Suppliers\Install\Schema\Suppliers as SuppliersSchema;
...
class Package extends BasePackage
{
    ...
    {
        $packagePath = '/applications/Ecom/Dashboard/Packages/Inventory/Suppliers/';
