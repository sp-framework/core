...
namespace Apps\Core\Components\Devtools\Api\Enums\Install;

use Apps\Core\Components\Devtools\Api\Enums\EnumsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(EnumsComponent::class)) {
    ...
    {
        $componentPath = '/apps/Dash/Components/Devtools/Api/Enums';
        ...
        [
            ...
            'settings'              =>
                ...
                null,
            'files'                 => Json::encode($this->basepackage->utils->scanDir($componentPath)),
            'updated_by'            => 0
        ];
