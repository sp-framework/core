...
class BackuprestoreComponent extends BaseComponent
{
    ...
    public function viewAction()
    {
        ...
        if (isset($this->getData()['analyse']) && $this->getData()['analyse'] == 'info') {
            $backupInfoFile = $this->basepackages->backuprestore->init()->analyseBackinfoFile($this->getData()['id']);
    ...
    public function backupAction()
    {
        ...
        if ($this->basepackages->backuprestore->init('backup')->backup($this->postData())) {
            $this->addResponse(
