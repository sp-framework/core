...
class ContractsXML
{
    ...
    protected $ebayServicesClass = '\\Apps\Core\Packages\System\Api\Apis\Ebay';
...
namespace Apps\Core\Packages\System\Api\Apis\Ebay\\' . $this->contract['name'] . '\Services;

use Apps\Core\Packages\System\Api\Apis\Ebay\EbayXMLService;
use Apps\Core\Packages\System\Api\Base\Types\BaseType;
...
use Apps\Core\Packages\System\Api\Apis\Ebay\\' . $this->contract['name'] . '\Services\\' . $this->contract['name'] . 'BaseService;
...
namespace Apps\Core\Packages\System\Api\Apis\Ebay\\' . $this->contract['name'] . '\Types;
...
{';
        ...
        if (isset($type['properties'])) {
            ...
            if ($typeKey === 'AbstractRequestType') {
                ...
                $propertyTypes['RequesterCredentials']['type'] = 'Apps\Core\Packages\System\Api\Apis\Ebay\\' . $this->contract['name'] . '\Types\CustomSecurityHeaderType';
    ...
    protected function getRefClass($item)
    {
        ...
        return 'Apps\Core\Packages\System\Api\Apis\Ebay\\' . $this->contract['name'] . '\Types\\' . Arr::last($itemArr);
    }
                ...
                if (is_array($type['allOf'])) {
                    ...
                    foreach ($type['allOf'] as $allOfKey => $allOf) {
                        ...
                        if (isset($allOf['$ref'])) {
                            ...
                            $extends = '\Apps\Core\Packages\System\Api\Base\Types\BaseType';
                        }
...
namespace Apps\Core\Packages\System\Api\Apis\Ebay\\' . $this->contract['name'] . '\Operations;
