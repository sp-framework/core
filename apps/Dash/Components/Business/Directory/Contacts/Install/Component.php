...
namespace Apps\Dash\Components\Business\Directory\Contacts\Install;

use Apps\Dash\Components\Business\Directory\Contacts\ContactsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(ContactsComponent::class)) {
    ...
    {
        $componentPath = '/apps/Dash/Components/Business/Directory/Contacts/';
