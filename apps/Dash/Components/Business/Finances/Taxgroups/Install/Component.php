...
namespace Apps\Dash\Components\Business\Finances\Taxgroups\Install;

use Apps\Dash\Components\Business\Finances\Taxgroups\TaxgroupsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(TaxgroupsComponent::class)) {
