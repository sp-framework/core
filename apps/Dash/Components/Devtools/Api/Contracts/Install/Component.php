...
namespace Apps\Dash\Components\Devtools\Api\Contracts\Install;

use Apps\Dash\Components\Devtools\Api\Contracts\ContractsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(ContractsComponent::class)) {
    ...
    {
        $componentPath = '/apps/Dash/Components/Devtools/Api/Contracts';
