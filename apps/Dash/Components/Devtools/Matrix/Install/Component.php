...
namespace Apps\Dash\Components\Devtools\Matrix\Install;

use Apps\Dash\Components\Devtools\Matrix\MatrixComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(MatrixComponent::class)) {
    ...
    {
        $componentPath = '/apps/Dash/Components/Devtools/Matrix';
