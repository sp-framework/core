...
namespace Apps\Dash\Components\Hrms\Designations\Install;

use Apps\Dash\Components\Hrms\Designations\DesignationsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/apps/Dash/Components/Hrms/Designations';
