...
namespace Apps\Dash\Components\Hrms\Employees\Install;

use Apps\Dash\Components\Hrms\Employees\EmployeesComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/apps/Dash/Components/Hrms/Employees/';
