...
namespace Apps\Dash\Components\Hrms\Statuses\Install;

use Apps\Dash\Components\Hrms\Statuses\StatusesComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/apps/Dash/Components/Hrms/Statuses';
