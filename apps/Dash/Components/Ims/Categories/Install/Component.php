...
namespace Apps\Dash\Components\Ims\Categories\Install;

use Apps\Dash\Components\Ims\Categories\CategoriesComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/apps/Dash/Components/Ims/Categories/';
