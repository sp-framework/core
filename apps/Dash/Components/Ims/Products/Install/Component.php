...
namespace Apps\Dash\Components\Ims\Products\Install;

use Apps\Dash\Components\Ims\Products\ProductsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/apps/Dash/Components/Ims/Products/';
