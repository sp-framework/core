...
namespace Apps\Dash\Components\Ims\Specifications\Install;

use Apps\Dash\Components\Ims\Specifications\SpecificationsComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/apps/Dash/Components/Ims/Specifications/';
