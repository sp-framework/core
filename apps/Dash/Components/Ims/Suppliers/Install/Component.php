...
namespace Apps\Dash\Components\Ims\Suppliers\Install;

use Apps\Dash\Components\Ims\Suppliers\SuppliersComponent;
...
class Component extends BaseComponent
{
    ...
    {
        $componentPath = '/apps/Dash/Components/Ims/Suppliers/';
