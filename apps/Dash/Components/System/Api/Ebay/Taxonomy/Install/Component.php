...
namespace Apps\Dash\Components\System\Api\Ebay\Taxonomy\Install;

use Apps\Dash\Components\System\Api\Ebay\Taxonomy\TaxonomyComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(TaxonomyComponent::class)) {
    ...
    {
        $componentPath = '/apps/Dash/Components/System/Api/Ebay/Taxonomy';
