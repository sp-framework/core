...
namespace Apps\Dash\Components\System\Templates\Install;

use Apps\Dash\Components\System\Templates\TemplatesComponent;
...
class Component extends BaseComponent
{
    ...
    {
        if ($this->checkComponent(TemplatesComponent::class)) {
    ...
    {
        $componentPath = '/apps/Dash/Components/Templates/';
