                                                    ...
                                                    <div class="row">
                                                        <div class="col list-group-item-data">
                                                            <dl class="row mb-0">
                                                                ...
                                                                <dd class="text-uppercase mb-0 col-sm-8 cla-email">' . $contact['account_email'] . '</dd>
                                                                <dt class="text-uppercase mb-0 col-sm-4">Mobile</dt>
                                                                <dd class="text-uppercase mb-0 col-sm-8 cla-mobile">' . $contact['contact_mobile'] . '</dd>
                                                                <dt class="text-uppercase mb-0 col-sm-4">First Name</dt>
                                                                <dd class="text-uppercase mb-0 col-sm-8 cla-first-name">' . $contact['first_name'] . '</dd>
                                                                <dt class="text-uppercase mb-0 col-sm-4">Last Name</dt>
                                                                <dd class="text-uppercase mb-0 col-sm-8 cla-last-name">' . $contact['last_name'] . '</dd>
                                                                <dt class="text-uppercase mb-0 col-sm-4">Phone</dt>
                                                                <dd class="text-uppercase mb-0 col-sm-8 cla-state">' . $contact['contact_phone'] . '</dd>
                                                                <dt class="text-uppercase mb-0 col-sm-4">Extension</dt>
                                                                <dd class="text-uppercase mb-0 col-sm-8 cla-extension">' . $contact['contact_phone_ext'] . '</dd>
                                                            </dl>
                                                        </div>
                                                    </div>
                                                </li>';
                            ...
                            function extractData() {
                                if ($("#' . $this->compSecId . '-account_email").val() === "") {
                                    ...
                                    var html =
                                        \'<dl class="row mb-0">\' +
                                            \'<dt class="text-uppercase mb-0 col-sm-4">Email</dt>\' +
                                            \'<dd class="text-uppercase mb-0 col-sm-8 cla-email">\' + data["account_email"] + \'</dd>\' +
                                            \'<dt class="text-uppercase mb-0 col-sm-4">Mobile</dt>\' +
                                            \'<dd class="text-uppercase mb-0 col-sm-8 cla-mobile">\' + data["contact_mobile"] + \'</dd>\' +
                                            \'<dt class="text-uppercase mb-0 col-sm-4">First Name</dt>\' +
                                            \'<dd class="text-uppercase mb-0 col-sm-8 cla-first-name">\' + data["first_name"] + \'</dd>\' +
                                            \'<dt class="text-uppercase mb-0 col-sm-4">Last Name</dt>\' +
                                            \'<dd class="text-uppercase mb-0 col-sm-8 cla-last-name">\' + data["last_name"] + \'</dd>\' +
                                            \'<dt class="text-uppercase mb-0 col-sm-4">Phone</dt>\' +
                                            \'<dd class="text-uppercase mb-0 col-sm-8 cla-phone">\' + data["contact_phone"] + \'</dd>\' +
                                            \'<dt class="text-uppercase mb-0 col-sm-4">Extension</dt>\' +
                                            \'<dd class="text-uppercase mb-0 col-sm-8 cla-extension">\' + data["contact_phone_ext"] + \'</dd>\' +
                                        \'</dl>\';
