...
namespace Apps\Dash\Packages\Business\Directory\Contacts\Install;

use Apps\Dash\Packages\Business\Directory\Contacts\Install\Schema\Contacts as ContactsSchema;
...
{
    protected $schemaToUse = ContactsSchema::class;

    protected $packageToUse = Contacts::class;
    ...
    public function installPackage(bool $dropTables = false)
    {
        ...
        try {
            if ($dropTables) {
                $this->createTable('business_directory_contacts', '', (new $this->schemaToUse)->columns(), $dropTables);
            } else {
                $this->createTable('business_directory_contacts', '', (new $this->schemaToUse)->columns());
            }
