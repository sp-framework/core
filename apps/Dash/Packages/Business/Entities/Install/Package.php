...
namespace Apps\Dash\Packages\Business\Entities\Install;

use Apps\Dash\Packages\Business\Entities\Entities;
use Apps\Dash\Packages\Business\Entities\Install\Schema\Entities as EntitiesSchema;
use Phalcon\Helper\Json;
use System\Base\BasePackage;

class Package extends BasePackage
{
    protected $schemaToUse = EntitiesSchema::class;

    protected $packageToUse = Entities::class;
    ...
    public function installPackage(bool $dropTables = false)
    {
        ...
        try {
            if ($dropTables) {
                $this->createTable('business_entities', '', (new $this->schemaToUse)->columns(), $dropTables);
            } else {
                $this->createTable('business_entities', '', (new $this->schemaToUse)->columns());
            }
    ...
    {
        $packagePath = '/apps/Dash/Packages/Business/Entities';
