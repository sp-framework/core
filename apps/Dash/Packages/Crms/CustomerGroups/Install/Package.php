...
namespace Apps\Dash\Packages\Crms\CustomerGroups\Install;

use Apps\Dash\Packages\Crms\CustomerGroups\Install\Schema\CrmsCustomerGroups;
use Phalcon\Helper\Json;
use System\Base\BasePackage;

class Package extends BasePackage
{
    protected $schemaToUse = CrmsCustomerGroups::class;
    ...
    public function installPackage(bool $dropTables = false)
    {
        ...
        try {
            if ($dropTables) {
                $this->createTable('crms_customer_groups', '', (new $this->schemaToUse)->columns(), $dropTables);
            } else {
                $this->createTable('crms_customer_groups', '', (new $this->schemaToUse)->columns());
            }
    ...
    {
        $packagePath = '/apps/Dash/Packages/Crms/CustomerGroups/';
