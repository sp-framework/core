...
namespace Apps\Dash\Packages\Hrms\Designations\Install;

use Apps\Dash\Packages\Hrms\Designations\HrmsDesignations;
use Apps\Dash\Packages\Hrms\Designations\Install\Schema\HrmsDesignations as HrmsDesignationsSchema;
...
class Package extends BasePackage
{
    ...
    {
        $packagePath = '/apps/Dash/Packages/Hrms/Designations';
