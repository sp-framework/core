...
use Apps\Dash\Packages\System\Api\Apis\Ebay\Credentials\Credentials;
use Apps\Dash\Packages\System\Api\Apis\Ebay\Credentials\CredentialsInterface;
use Apps\Dash\Packages\System\Api\Apis\Ebay\Credentials\CredentialsProvider;
use Apps\Dash\Packages\System\Api\Apis\Ebay\Debugger;
use Apps\Dash\Packages\System\Api\Apis\Ebay\HttpHandler;
...
class Functions
{
     ...
     */
    public static function applyCredentials($value, array &$configuration)
    {
        var_dump($value, $configuration);
        if (is_callable($value)) {
            ...
            throw new \InvalidArgumentException(
                ...
                . 'Apps\Dash\Packages\System\Api\Apis\Ebay\Credentials\CredentialsInterface, an associative '
     ...
     */
    public static function applyProfile($value, array &$configuration)
    {
