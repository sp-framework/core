...
class TradingapiBaseService extends BaseXMLService
{
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \Apps\Dash\Packages\System\Api\Apis\Ebay\Tradingapi\Services\TradingapiService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string']
    ...
    {
        if ($request->hasAttachment() && $request instanceof \Apps\Dash\Packages\System\Api\Apis\Ebay\Tradingapi\Types\UploadSiteHostedPicturesRequest) {
