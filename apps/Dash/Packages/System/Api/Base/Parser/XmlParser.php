...
namespace Apps\Dash\Packages\System\Api\Base\Parser;
...
class XmlParser
{
    ...
    {
        return (
            is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\Base64BinaryType', false) ||
            is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\BooleanType', false) ||
            is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\DecimalType', false) ||
            is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\DoubleType', false) ||
            is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\IntegerType', false) ||
            is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\StringType', false) ||
            is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\TokenType', false) ||
            is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\URIType', false)
        );
    }
    ...
    {
        if (is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\Base64BinaryType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\BooleanType', false)) {
            return strtolower($meta->strData) === 'true';
        } elseif (is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\DecimalType', false)) {
            return is_int(0 + $meta->strData) ? (integer)$meta->strData : (double)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\DoubleType', false)) {
            return (double)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\IntegerType', false)) {
            return (integer)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\StringType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\TokenType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\Apps\Dash\Packages\System\Api\Base\Types\URIType', false)) {
            return $meta->strData;
        }
