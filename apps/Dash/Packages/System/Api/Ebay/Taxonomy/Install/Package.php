...
namespace Apps\Dash\Packages\System\Api\Ebay\Taxonomy\Install;

use Apps\Dash\Packages\System\Api\Ebay\Taxonomy\EbayTaxonomy;
use Apps\Dash\Packages\System\Api\Ebay\Taxonomy\Install\Schema\SystemApiEbayTaxonomy;
use Phalcon\Helper\Json;
use System\Base\BasePackage;

class Package extends BasePackage
{
    protected $packageToUse = EbayTaxonomy::class;
    ...
    public function installPackage(bool $dropTables = false)
    {
        ...
        try {
            if ($dropTables) {
                try {
                    $this->createTable('system_api_ebay_taxonomy', '', (new SystemApiEbayTaxonomy)->columns(), $dropTables);
                } catch (\Exception $e) {
                    var_dump($e);die();
                }
            } else {
                $this->createTable('system_api_ebay_taxonomy', '', (new SystemApiEbayTaxonomy)->columns());
            }
    ...
    {
        $packagePath = '/apps/Dash/Packages/System/Api/Ebay/Taxonomy';
