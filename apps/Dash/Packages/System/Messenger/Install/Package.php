...
namespace Apps\Dash\Packages\System\Messenger\Install;
...
{
    protected $schemaToUse = SystemMessenger::class;

    protected $packageToUse = Messenger::class;
    ...
    public function installPackage(bool $dropTables = false)
    {
        ...
        try {
            if ($dropTables) {
                try {
                    $this->createTable('system_messenger', '', (new $this->schemaToUse)->columns(), $dropTables);
                } catch (\Exception $e) {
                    var_dump($e);die();
                }
            } else {
                $this->createTable('system_messenger', '', (new $this->schemaToUse)->columns());
            }
