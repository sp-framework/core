 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateFileOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateFileOptions';
     ...
     * Sets from_path
     *
     * @param string $from_path from_path (optional) is the path of the original file which will be moved/renamed to the path in the URL
     *
     * @return $this
     */
