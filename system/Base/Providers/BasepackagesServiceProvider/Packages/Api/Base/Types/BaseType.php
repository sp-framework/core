...
use System\Base\Providers\BasepackagesServiceProvider\Packages\Api\Base\Exceptions\InvalidPropertyTypeException;
use System\Base\Providers\BasepackagesServiceProvider\Packages\Api\Base\Exceptions\UnknownPropertyException;
use System\Base\Providers\BasepackagesServiceProvider\Packages\Api\Base\JmesPath\Env;
use System\Base\Providers\BasepackagesServiceProvider\Packages\Api\Base\Types\RepeatableType;
...
class BaseType
{
     ...
     *     'attribute'      => false,     Indicates if the property is an attribute in the XML.
     *     'elementName'    => 'Subject'  The corresponding element in the XML.
     * ]
     *
     */
     ...
     *
     * @return mixed Returns the contents of the current attachment or null if none has been specified.
     */
