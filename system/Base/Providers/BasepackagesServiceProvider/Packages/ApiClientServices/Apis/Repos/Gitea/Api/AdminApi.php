...
class AdminApi
{
     ...
     */
    public function adminGetAllEmails($page = null, $limit = null)
    {
        list($response) = $this->adminGetAllEmailsWithHttpInfo($page, $limit);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminGetAllEmailsAsync($page = null, $limit = null)
    {
        return $this->adminGetAllEmailsAsyncWithHttpInfo($page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminGetAllEmailsAsyncWithHttpInfo($page = null, $limit = null)
    {
        $returnType = '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\Email[]';
        $request = $this->adminGetAllEmailsRequest($page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function adminGetAllEmailsRequest($page = null, $limit = null)
    {
     ...
     * @return void
     */
    public function adminRenameUser($username, $body)
    {
        $this->adminRenameUserWithHttpInfo($username, $body);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function adminRenameUserWithHttpInfo($username, $body)
    {
        $returnType = '';
        $request = $this->adminRenameUserRequest($username, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminRenameUserAsync($username, $body)
    {
        return $this->adminRenameUserAsyncWithHttpInfo($username, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminRenameUserAsyncWithHttpInfo($username, $body)
    {
        $returnType = '';
        $request = $this->adminRenameUserRequest($username, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function adminRenameUserRequest($username, $body)
    {
        // verify the required parameter 'username' is set
        if ($username === null || (is_array($username) && count($username) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\Email[]
     */
    public function adminSearchEmails($q = null, $page = null, $limit = null)
    {
        list($response) = $this->adminSearchEmailsWithHttpInfo($q, $page, $limit);
        return $response;
    }
     ...
     * @return array of \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\Email[], HTTP status code, HTTP response headers (array of strings)
     */
    public function adminSearchEmailsWithHttpInfo($q = null, $page = null, $limit = null)
    {
        $returnType = '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\Email[]';
        $request = $this->adminSearchEmailsRequest($q, $page, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminSearchEmailsAsync($q = null, $page = null, $limit = null)
    {
        return $this->adminSearchEmailsAsyncWithHttpInfo($q, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminSearchEmailsAsyncWithHttpInfo($q = null, $page = null, $limit = null)
    {
        $returnType = '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\Email[]';
        $request = $this->adminSearchEmailsRequest($q, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function adminSearchEmailsRequest($q = null, $page = null, $limit = null)
    {
     ...
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\User[]
     */
    public function adminSearchUsers($source_id = null, $login_name = null, $page = null, $limit = null)
    {
        list($response) = $this->adminSearchUsersWithHttpInfo($source_id, $login_name, $page, $limit);
        return $response;
    }
     ...
     * @return array of \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\User[], HTTP status code, HTTP response headers (array of strings)
     */
    public function adminSearchUsersWithHttpInfo($source_id = null, $login_name = null, $page = null, $limit = null)
    {
        $returnType = '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\User[]';
        $request = $this->adminSearchUsersRequest($source_id, $login_name, $page, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminSearchUsersAsync($source_id = null, $login_name = null, $page = null, $limit = null)
    {
        return $this->adminSearchUsersAsyncWithHttpInfo($source_id, $login_name, $page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adminSearchUsersAsyncWithHttpInfo($source_id = null, $login_name = null, $page = null, $limit = null)
    {
        $returnType = '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\User[]';
        $request = $this->adminSearchUsersRequest($source_id, $login_name, $page, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function adminSearchUsersRequest($source_id = null, $login_name = null, $page = null, $limit = null)
    {
        ...
        // query params
        if ($login_name !== null) {
            $queryParams['login_name'] = ObjectSerializer::toQueryValue($login_name);
        }
        // query params
        if ($page !== null) {
            $queryParams['page'] = ObjectSerializer::toQueryValue($page);
