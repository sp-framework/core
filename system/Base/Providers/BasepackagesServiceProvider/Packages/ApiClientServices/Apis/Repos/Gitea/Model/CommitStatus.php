...
class CommitStatus implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'description' => 'string',
        'id' => 'int',
        'status' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\CommitStatusState',
        'target_url' => 'string',
        'updated_at' => '\DateTime',
        'url' => 'string'
    ];
     ...
     * Sets status
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\CommitStatusState $status status
     *
     * @return $this
     */
