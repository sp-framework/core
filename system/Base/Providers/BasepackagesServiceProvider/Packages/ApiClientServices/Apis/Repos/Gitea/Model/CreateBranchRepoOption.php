...
class CreateBranchRepoOption implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['old_ref_name'] = isset($data['old_ref_name']) ? $data['old_ref_name'] : null;
    }
     ...
     *
     * @param string $old_branch_name Deprecated: true Name of the old branch to create from
     *
     * @return $this
     */
     ...
     * Sets old_ref_name
     *
     * @param string $old_ref_name Name of the old branch/tag/commit to create from
     *
     * @return $this
     */
