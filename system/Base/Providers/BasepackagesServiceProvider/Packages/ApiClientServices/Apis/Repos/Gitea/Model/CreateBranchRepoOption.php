...
class CreateBranchRepoOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'new_branch_name' => false,
        'old_branch_name' => false,
        'old_ref_name' => false
    ];
    ...
    {
        $this->setIfExists('new_branch_name', $data ?? [], null);
        $this->setIfExists('old_branch_name', $data ?? [], null);
        $this->setIfExists('old_ref_name', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($new_branch_name)) {
            throw new \InvalidArgumentException('non-nullable new_branch_name cannot be null');
        }
     ...
     *
     * @param string|null $old_branch_name Deprecated: true Name of the old branch to create from
     *
     * @return self
     */
    public function setOldBranchName($old_branch_name)
    {
        if (is_null($old_branch_name)) {
            throw new \InvalidArgumentException('non-nullable old_branch_name cannot be null');
        }
     ...
     * @return string|null
     */
    public function getOldRefName()
    {
        return $this->container['old_ref_name'];
    }

    /**
     * Sets old_ref_name
     *
     * @param string|null $old_ref_name Name of the old branch/tag/commit to create from
     *
     * @return self
     */
    public function setOldRefName($old_ref_name)
    {
        if (is_null($old_ref_name)) {
            throw new \InvalidArgumentException('non-nullable old_ref_name cannot be null');
        }
        $this->container['old_ref_name'] = $old_ref_name;
