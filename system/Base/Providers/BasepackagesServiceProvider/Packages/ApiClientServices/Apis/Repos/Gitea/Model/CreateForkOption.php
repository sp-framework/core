 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateForkOption implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateForkOption';
     ...
     * Sets name
     *
     * @param string $name name of the forked repository
     *
     * @return $this
     */
     ...
     * Sets organization
     *
     * @param string $organization organization name, if forking into an organization
     *
     * @return $this
     */
