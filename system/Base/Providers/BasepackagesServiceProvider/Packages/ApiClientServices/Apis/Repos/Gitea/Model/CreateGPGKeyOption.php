...
class CreateGPGKeyOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('armored_signature', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($armored_signature)) {
            throw new \InvalidArgumentException('non-nullable armored_signature cannot be null');
        }
