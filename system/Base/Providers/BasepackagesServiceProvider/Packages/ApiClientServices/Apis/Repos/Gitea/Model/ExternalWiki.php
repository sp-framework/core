...
class ExternalWiki implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('external_wiki_url', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($external_wiki_url)) {
            throw new \InvalidArgumentException('non-nullable external_wiki_url cannot be null');
        }
