...
class GeneralRepoSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('http_git_disabled', $data ?? [], null);
        $this->setIfExists('lfs_disabled', $data ?? [], null);
        $this->setIfExists('migrations_disabled', $data ?? [], null);
        $this->setIfExists('mirrors_disabled', $data ?? [], null);
        $this->setIfExists('stars_disabled', $data ?? [], null);
        $this->setIfExists('time_tracking_disabled', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($http_git_disabled)) {
            throw new \InvalidArgumentException('non-nullable http_git_disabled cannot be null');
        }
    ...
    {
        if (is_null($lfs_disabled)) {
            throw new \InvalidArgumentException('non-nullable lfs_disabled cannot be null');
        }
    ...
    {
        if (is_null($migrations_disabled)) {
            throw new \InvalidArgumentException('non-nullable migrations_disabled cannot be null');
        }
    ...
    {
        if (is_null($mirrors_disabled)) {
            throw new \InvalidArgumentException('non-nullable mirrors_disabled cannot be null');
        }
    ...
    {
        if (is_null($stars_disabled)) {
            throw new \InvalidArgumentException('non-nullable stars_disabled cannot be null');
        }
    ...
    {
        if (is_null($time_tracking_disabled)) {
            throw new \InvalidArgumentException('non-nullable time_tracking_disabled cannot be null');
        }
