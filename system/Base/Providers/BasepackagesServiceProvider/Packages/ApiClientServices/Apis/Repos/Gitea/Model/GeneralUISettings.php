...
class GeneralUISettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('allowed_reactions', $data ?? [], null);
        $this->setIfExists('custom_emojis', $data ?? [], null);
        $this->setIfExists('default_theme', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($allowed_reactions)) {
            throw new \InvalidArgumentException('non-nullable allowed_reactions cannot be null');
        }
    ...
    {
        if (is_null($custom_emojis)) {
            throw new \InvalidArgumentException('non-nullable custom_emojis cannot be null');
        }
    ...
    public function setDefaultTheme($default_theme)
    {
        if (is_null($default_theme)) {
            throw new \InvalidArgumentException('non-nullable default_theme cannot be null');
        }
