...
/**
 * LicenseTemplateInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class LicenseTemplateInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LicenseTemplateInfo';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('implementation', $data ?? [], null);
    ...
    */
     ...
     * Sets implementation
     *
     * @param string|null $implementation implementation
     *
     * @return self
     */
    public function setImplementation($implementation)
    {
        if (is_null($implementation)) {
            throw new \InvalidArgumentException('non-nullable implementation cannot be null');
        }
