...
class NodeInfoUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('local_comments', $data ?? [], null);
        $this->setIfExists('local_posts', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($local_comments)) {
            throw new \InvalidArgumentException('non-nullable local_comments cannot be null');
        }
    ...
    {
        if (is_null($local_posts)) {
            throw new \InvalidArgumentException('non-nullable local_posts cannot be null');
        }
     ...
     * Gets users
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\NodeInfoUsageUsers|null
     */
     ...
     * Sets users
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\NodeInfoUsageUsers|null $users users
     *
     * @return self
     */
