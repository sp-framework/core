...
class NodeInfoUsageUsers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('active_halfyear', $data ?? [], null);
        $this->setIfExists('active_month', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($active_halfyear)) {
            throw new \InvalidArgumentException('non-nullable active_halfyear cannot be null');
        }
    ...
    {
        if (is_null($active_month)) {
            throw new \InvalidArgumentException('non-nullable active_month cannot be null');
        }
