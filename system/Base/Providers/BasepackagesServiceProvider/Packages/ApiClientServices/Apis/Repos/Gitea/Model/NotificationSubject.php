...
class NotificationSubject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('latest_comment_html_url', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($latest_comment_html_url)) {
            throw new \InvalidArgumentException('non-nullable latest_comment_html_url cannot be null');
        }
