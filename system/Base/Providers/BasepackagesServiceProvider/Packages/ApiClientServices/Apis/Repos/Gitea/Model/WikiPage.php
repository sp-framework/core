...
class WikiPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('last_commit', $data ?? [], null);
        $this->setIfExists('sidebar', $data ?? [], null);
        $this->setIfExists('sub_url', $data ?? [], null);
    ...
    */
     ...
     * Gets last_commit
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\WikiCommit|null
     */
     ...
     * Sets last_commit
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Gitea\Model\WikiCommit|null $last_commit last_commit
     *
     * @return self
     */
    public function setLastCommit($last_commit)
    {
        if (is_null($last_commit)) {
            throw new \InvalidArgumentException('non-nullable last_commit cannot be null');
        }
    ...
    {
        if (is_null($sub_url)) {
            throw new \InvalidArgumentException('non-nullable sub_url cannot be null');
        }
