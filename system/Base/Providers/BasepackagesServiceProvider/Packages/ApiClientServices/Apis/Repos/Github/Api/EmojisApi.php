...
class EmojisApi
{
     ...
     * Get emojis
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emojisGet'] to see the possible values for this operation
     *
     ...
     */
    public function emojisGet(string $contentType = self::contentTypes['emojisGet'][0])
    {
        list($response) = $this->emojisGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation emojisGetWithHttpInfo
     *
     * Get emojis
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emojisGet'] to see the possible values for this operation
     ...
     */
    public function emojisGetWithHttpInfo(string $contentType = self::contentTypes['emojisGet'][0])
    {
        $request = $this->emojisGetRequest($contentType);
     ...
     */
    public function emojisGetAsync(string $contentType = self::contentTypes['emojisGet'][0])
    {
        return $this->emojisGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation emojisGetAsyncWithHttpInfo
     *
     * Get emojis
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emojisGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function emojisGetAsyncWithHttpInfo(string $contentType = self::contentTypes['emojisGet'][0])
    {
        $returnType = 'array<string,string>';
        $request = $this->emojisGetRequest($contentType);
    ...
    /**
     * Create request for operation 'emojisGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emojisGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function emojisGetRequest(string $contentType = self::contentTypes['emojisGet'][0])
    {
