...
/**
 * ActionsReviewCustomGatesForRunRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ActionsReviewCustomGatesForRunRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'actions_review_custom_gates_for_run_request';
    ...
    */
     ...
     *
     * @param string $environment_name The name of the environment to approve or reject.
     *
     * @return self
     */
     ...
     * Sets comment
     *
     * @param string $comment Optional comment to include with the review.
     *
     * @return self
     */
