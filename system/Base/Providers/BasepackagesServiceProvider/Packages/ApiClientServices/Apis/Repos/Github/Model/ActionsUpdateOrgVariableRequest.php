...
/**
 * ActionsUpdateOrgVariableRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ActionsUpdateOrgVariableRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'actions_update_org_variable_request';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value The value of the variable.
     *
     * @return self
     */
     ...
     * Sets visibility
     *
     * @param string|null $visibility The type of repositories in the organization that can access the variable. `selected` means only the repositories specified by `selected_repository_ids` can access the variable.
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $selected_repository_ids An array of repository ids that can access the organization variable. You can only provide a list of repository ids when the `visibility` is set to `selected`.
     *
     * @return self
     */
