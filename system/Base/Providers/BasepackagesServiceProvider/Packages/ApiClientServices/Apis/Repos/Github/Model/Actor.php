...
class Actor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('display_login', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['display_login'];
    }

    /**
     * Sets display_login
     *
     * @param string|null $display_login display_login
     *
     * @return self
     */
    public function setDisplayLogin($display_login)
    {
        if (is_null($display_login)) {
            throw new \InvalidArgumentException('non-nullable display_login cannot be null');
        }
        $this->container['display_login'] = $display_login;
