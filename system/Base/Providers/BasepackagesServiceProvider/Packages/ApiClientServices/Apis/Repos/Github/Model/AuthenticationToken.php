...
class AuthenticationToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'authentication-token';
    ...
    */
     ...
     * Sets expires_at
     *
     * @param \DateTime $expires_at The time this token expires
     *
     * @return self
     */
     ...
     * Sets repositories
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\Repository[]|null $repositories The repositories this token has access to
     *
     * @return self
     */
     ...
     *
     * @param string|null $repository_selection Describe whether all repositories have been selected or there's a selection involved
     *
     * @return self
     */
