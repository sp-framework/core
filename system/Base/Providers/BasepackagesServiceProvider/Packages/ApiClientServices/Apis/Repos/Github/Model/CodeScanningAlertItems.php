...
/**
 * CodeScanningAlertItems Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class CodeScanningAlertItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'code-scanning-alert-items';
    ...
    */
    ...
    public function setDismissedComment($dismissed_comment)
    {
        ...
        if (!is_null($dismissed_comment) && (mb_strlen($dismissed_comment) > 280)) {
            throw new \InvalidArgumentException('invalid length for $dismissed_comment when calling CodeScanningAlertItems., must be smaller than or equal to 280.');
        }
