 ...
 */
class Codespace implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'codespace';
    ...
    protected static $setters = [
        ...
        'last_known_stop_notice' => 'setLastKnownStopNotice'
    ];
    ...
    protected static $getters = [
        ...
        'last_known_stop_notice' => 'getLastKnownStopNotice'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('last_known_stop_notice', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets last_known_stop_notice
     *
     * @return string|null
     */
    public function getLastKnownStopNotice()
    {
        return $this->container['last_known_stop_notice'];
    }

    /**
     * Sets last_known_stop_notice
     *
     * @param string|null $last_known_stop_notice The text to display to a user when a codespace has been stopped for a potentially actionable reason.
     *
     * @return self
     */
    public function setLastKnownStopNotice($last_known_stop_notice)
    {
        if (is_null($last_known_stop_notice)) {
            array_push($this->openAPINullablesSetToNull, 'last_known_stop_notice');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_known_stop_notice', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['last_known_stop_notice'] = $last_known_stop_notice;
