...
/**
 * CodespacesCreateOrUpdateRepoSecretRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class CodespacesCreateOrUpdateRepoSecretRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'codespaces_create_or_update_repo_secret_request';
    ...
    */
    ...
    public function setEncryptedValue($encrypted_value)
    {
        ...
        if ((!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=|[A-Za-z0-9+\/]{4})$/", ObjectSerializer::toString($encrypted_value)))) {
            throw new \InvalidArgumentException("invalid value for \$encrypted_value when calling CodespacesCreateOrUpdateRepoSecretRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=|[A-Za-z0-9+\/]{4})$/.");
        }
