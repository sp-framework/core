...
/**
 * CodespacesPermissionsCheckForDevcontainer Class Doc Comment
 *
 * @category Class
 ...
 */
class CodespacesPermissionsCheckForDevcontainer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'codespaces-permissions-check-for-devcontainer';
    ...
    */
     ...
     * Sets accepted
     *
     * @param bool $accepted Whether the user has accepted the permissions defined by the devcontainer config
     *
     * @return self
     */
