...
/**
 * CodespacesPreFlightWithRepoForAuthenticatedUser200ResponseDefaults Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class CodespacesPreFlightWithRepoForAuthenticatedUser200ResponseDefaults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'codespaces_pre_flight_with_repo_for_authenticated_user_200_response_defaults';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['devcontainer_path'] === null) {
            $invalidProperties[] = "'devcontainer_path' can't be null";
        }
     ...
     *
     * @param string $devcontainer_path devcontainer_path
     *
     * @return self
     */
