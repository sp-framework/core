...
/**
 * CodespacesUpdateForAuthenticatedUserRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class CodespacesUpdateForAuthenticatedUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'codespaces_update_for_authenticated_user_request';
    ...
    */
     ...
     * Sets machine
     *
     * @param string|null $machine A valid machine to transition this codespace to.
     *
     * @return self
     */
     ...
     * Sets recent_folders
     *
     * @param string[]|null $recent_folders Recently opened folders inside the codespace. It is currently used by the clients to determine the folder path to load the codespace in.
     *
     * @return self
     */
