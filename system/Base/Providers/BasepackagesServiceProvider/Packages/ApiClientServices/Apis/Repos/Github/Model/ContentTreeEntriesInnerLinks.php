...
/**
 * ContentTreeEntriesInnerLinks Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ContentTreeEntriesInnerLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'content_tree_entries_inner__links';
    ...
    */
    ...
    {
        if (is_null($git)) {
            array_push($this->openAPINullablesSetToNull, 'git');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('git', $nullablesSetToNull);
            if ($index !== FALSE) {
