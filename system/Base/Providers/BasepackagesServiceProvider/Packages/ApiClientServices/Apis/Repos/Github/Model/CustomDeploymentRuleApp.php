...
/**
 * CustomDeploymentRuleApp Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomDeploymentRuleApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'custom-deployment-rule-app';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id The unique identifier of the deployment protection rule integration.
     *
     * @return self
     */
     ...
     * Sets slug
     *
     * @param string $slug The slugified name of the deployment protection rule integration.
     *
     * @return self
     */
     ...
     *
     * @param string $integration_url The URL for the endpoint to get details about the app.
     *
     * @return self
     */
     ...
     * Sets node_id
     *
     * @param string $node_id The node ID for the deployment protection rule integration.
     *
     * @return self
     */
