...
/**
 * DependabotAlertPackage Class Doc Comment
 *
 * @category Class
 ...
 */
class DependabotAlertPackage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dependabot-alert-package';
    ...
    */
     ...
     * Sets ecosystem
     *
     * @param string $ecosystem The package's language or package management ecosystem.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The unique package name within its ecosystem.
     *
     * @return self
     */
