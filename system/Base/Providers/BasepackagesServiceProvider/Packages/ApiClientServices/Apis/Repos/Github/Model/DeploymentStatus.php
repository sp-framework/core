...
class DeploymentStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deployment-status';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('environment', $data ?? [], '');
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 140)) {
            throw new \InvalidArgumentException('invalid length for $description when calling DeploymentStatus., must be smaller than or equal to 140.');
        }
     ...
     * Sets environment
     *
     * @param string|null $environment The environment of the deployment that the status is for.
     *
     * @return self
     */
     ...
     * Sets target_url
     *
     * @param string $target_url Deprecated: the URL to associate with this status.
     *
     * @return self
     */
     ...
     *
     * @param string|null $environment_url The URL for accessing your environment.
     *
     * @return self
     */
     ...
     * Sets log_url
     *
     * @param string|null $log_url The URL to associate with this status.
     *
     * @return self
     */
