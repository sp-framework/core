...
/**
 * EnterpriseAdminSetSelectedOrganizationsEnabledGithubActionsEnterpriseRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class EnterpriseAdminSetSelectedOrganizationsEnabledGithubActionsEnterpriseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'enterprise_admin_set_selected_organizations_enabled_github_actions_enterprise_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['selected_organization_ids'] === null) {
            $invalidProperties[] = "'selected_organization_ids' can't be null";
        }
     ...
     *
     * @param int[] $selected_organization_ids List of organization IDs to enable for GitHub Actions.
     *
     * @return self
     */
