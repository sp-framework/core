...
/**
 * GitRefObject Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class GitRefObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'git_ref_object';
    ...
    */
     ...
     * Sets sha
     *
     * @param string $sha SHA for the reference
     *
     * @return self
     */
    public function setSha($sha)
    {
        ...
        if ((mb_strlen($sha) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sha when calling GitRefObject., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($sha) < 40)) {
            throw new \InvalidArgumentException('invalid length for $sha when calling GitRefObject., must be bigger than or equal to 40.');
        }
