...
/**
 * IssuesSetLabelsRequestOneOf Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class IssuesSetLabelsRequestOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'issues_set_labels_request_oneOf';
    ...
    */
    ...
    public function setLabels($labels)
    {
        ...
        if ((count($labels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $labels when calling IssuesSetLabelsRequestOneOf., number of items must be greater than or equal to 1.');
        }
