...
/**
 * ManifestFile Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ManifestFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'manifest_file';
    ...
    */
     ...
     *
     * @param string|null $source_location The path of the manifest file relative to the root of the Git repository.
     *
     * @return self
     */
