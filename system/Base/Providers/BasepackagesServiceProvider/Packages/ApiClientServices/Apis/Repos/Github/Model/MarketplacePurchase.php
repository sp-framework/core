...
/**
 * MarketplacePurchase Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class MarketplacePurchase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Marketplace_Purchase';
    ...
    protected static $openAPITypes = [
        ...
        'on_free_trial' => 'bool',
        'plan' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhooksPreviousMarketplacePurchasePlan',
        'unit_count' => 'int'
    ];
    ...
    */
    ...
    public function setOnFreeTrial($on_free_trial)
    {
        if (is_null($on_free_trial)) {
            array_push($this->openAPINullablesSetToNull, 'on_free_trial');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('on_free_trial', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets plan
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhooksPreviousMarketplacePurchasePlan
     */
     ...
     * Sets plan
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhooksPreviousMarketplacePurchasePlan $plan plan
     *
     * @return self
     */
