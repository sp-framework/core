...
/**
 * MigrationsStartForAuthenticatedUserRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class MigrationsStartForAuthenticatedUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'migrations_start_for_authenticated_user_request';
    ...
    */
     ...
     *
     * @param bool|null $lock_repositories Lock the repositories being migrated at the start of the migration
     *
     * @return self
     */
     ...
     *
     * @param bool|null $exclude_attachments Do not include attachments in the migration
     *
     * @return self
     */
     ...
     *
     * @param bool|null $exclude_releases Do not include releases in the migration
     *
     * @return self
     */
     ...
     *
     * @param bool|null $exclude_owner_projects Indicates whether projects owned by the organization or users should be excluded.
     *
     * @return self
     */
     ...
     * Sets exclude
     *
     * @param string[]|null $exclude Exclude attributes from the API response to improve performance
     *
     * @return self
     */
     ...
     * Sets repositories
     *
     * @param string[] $repositories repositories
     *
     * @return self
     */
