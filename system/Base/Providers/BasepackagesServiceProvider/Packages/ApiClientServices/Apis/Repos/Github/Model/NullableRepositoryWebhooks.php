...
/**
 * NullableRepositoryWebhooks Class Doc Comment
 *
 * @category Class
 * @description The repository on GitHub where the event occurred. Webhook payloads contain the &#x60;repository&#x60; property when the event occurs from activity in a repository.
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NullableRepositoryWebhooks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'nullable-repository-webhooks';
    ...
    protected static $openAPITypes = [
        ...
        'template_repository' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\RepositoryWebhooksTemplateRepository',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('anonymous_access_enabled', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\RepositoryWebhooksTemplateRepository|null
     */
     ...
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\RepositoryWebhooksTemplateRepository|null $template_repository template_repository
     *
     * @return self
     */
     ...
     *
     * @param bool|null $allow_update_branch Whether or not a pull request head branch that is behind its base branch can always be updated even if it is not required to be up to date before merging.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $anonymous_access_enabled Whether anonymous git access is enabled for this repository
     *
     * @return self
     */
