...
/**
 * OrganizationActionsVariable Class Doc Comment
 *
 * @category Class
 ...
 */
class OrganizationActionsVariable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'organization-actions-variable';
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date and time at which the variable was created, in ISO 8601 format':' YYYY-MM-DDTHH:MM:SSZ.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at The date and time at which the variable was last updated, in ISO 8601 format':' YYYY-MM-DDTHH:MM:SSZ.
     *
     * @return self
     */
     ...
     * Sets visibility
     *
     * @param string $visibility Visibility of a variable
     *
     * @return self
     */
     ...
     *
     * @param string|null $selected_repositories_url selected_repositories_url
     *
     * @return self
     */
