...
/**
 * OrganizationProgrammaticAccessGrant Class Doc Comment
 *
 * @category Class
 ...
 */
class OrganizationProgrammaticAccessGrant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'organization-programmatic-access-grant';
    ...
    protected static $setters = [
        ...
        'access_granted_at' => 'setAccessGrantedAt',
    ...
    protected static $getters = [
        ...
        'access_granted_at' => 'getAccessGrantedAt',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('access_granted_at', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['access_granted_at'] === null) {
            $invalidProperties[] = "'access_granted_at' can't be null";
        }
     ...
     * Sets id
     *
     * @param int $id Unique identifier of the fine-grained personal access token. The `pat_id` used to get details about an approved fine-grained personal access token.
     *
     * @return self
     */
     ...
     *
     * @param string $repositories_url URL to the list of repositories the fine-grained personal access token can access. Only follow when `repository_selection` is `subset`.
     *
     * @return self
     */
    ...
    /**
     * Gets access_granted_at
     *
     * @return string
     */
    public function getAccessGrantedAt()
    {
        return $this->container['access_granted_at'];
    }

    /**
     * Sets access_granted_at
     *
     * @param string $access_granted_at Date and time when the fine-grained personal access token was approved to access the organization.
     *
     * @return self
     */
    public function setAccessGrantedAt($access_granted_at)
    {
        if (is_null($access_granted_at)) {
            throw new \InvalidArgumentException('non-nullable access_granted_at cannot be null');
        }
        $this->container['access_granted_at'] = $access_granted_at;
