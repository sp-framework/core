...
/**
 * OrgsCreateOrUpdateCustomPropertyRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class OrgsCreateOrUpdateCustomPropertyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'orgs_create_or_update_custom_property_request';
    ...
    */
    ...
    public function setAllowedValues($allowed_values)
    {
        ...
        if (!is_null($allowed_values) && (count($allowed_values) > 200)) {
            throw new \InvalidArgumentException('invalid value for $allowed_values when calling OrgsCreateOrUpdateCustomPropertyRequest., number of items must be less than or equal to 200.');
        }
