...
/**
 * PageDeployment Class Doc Comment
 *
 * @category Class
 ...
 */
class PageDeployment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'page-deployment';
    ...
    */
     ...
     * Sets status_url
     *
     * @param string $status_url The URI to monitor GitHub Pages deployment status.
     *
     * @return self
     */
     ...
     * Sets page_url
     *
     * @param string $page_url The URI to the deployed GitHub Pages.
     *
     * @return self
     */
     ...
     * Sets preview_url
     *
     * @param string|null $preview_url The URI to the deployed GitHub Pages preview.
     *
     * @return self
     */
