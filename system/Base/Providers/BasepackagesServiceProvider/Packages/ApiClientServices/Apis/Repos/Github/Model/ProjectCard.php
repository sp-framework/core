 ...
 */
class ProjectCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Project_Card';
    ...
    protected static $openAPITypes = [
        ...
        'content_url' => 'string',
        'created_at' => '\DateTime',
        'creator' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\User1',
        'id' => 'int',
        'node_id' => 'string',
        'note' => 'string',
        'project_url' => 'string',
    ...
    */
    ...
    public function setColumnId($column_id)
    {
        if (is_null($column_id)) {
            array_push($this->openAPINullablesSetToNull, 'column_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('column_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets creator
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\User1 $creator creator
     *
     * @return self
     */
