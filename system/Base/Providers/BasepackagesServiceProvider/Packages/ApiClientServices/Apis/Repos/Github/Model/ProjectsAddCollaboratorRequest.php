...
/**
 * ProjectsAddCollaboratorRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ProjectsAddCollaboratorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'projects_add_collaborator_request';
    ...
    {
        $this->setIfExists('permission', $data ?? [], 'write');
    }
    ...
    */
     ...
     * Sets permission
     *
     * @param string|null $permission The permission to grant the collaborator.
     *
     * @return self
     */
