...
/**
 * ProjectsUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ProjectsUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'projects_update_request';
    ...
    */
     ...
     * Sets body
     *
     * @param string|null $body Body of the project
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state State of the project; either 'open' or 'closed'
     *
     * @return self
     */
     ...
     *
     * @param string|null $organization_permission The baseline permission that all organization members have on this project
     *
     * @return self
     */
     ...
     * Sets private
     *
     * @param bool|null $private Whether or not this project can be seen by everyone.
     *
     * @return self
     */
