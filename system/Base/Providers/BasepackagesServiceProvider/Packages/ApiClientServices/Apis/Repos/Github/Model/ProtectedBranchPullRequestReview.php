...
/**
 * ProtectedBranchPullRequestReview Class Doc Comment
 *
 * @category Class
 ...
 */
class ProtectedBranchPullRequestReview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'protected-branch-pull-request-review';
    ...
    protected static $openAPITypes = [
        'url' => 'string',
        'dismissal_restrictions' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\ProtectedBranchPullRequestReviewDismissalRestrictions',
        'bypass_pull_request_allowances' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\ProtectedBranchPullRequestReviewBypassPullRequestAllowances',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dismiss_stale_reviews'] === null) {
            $invalidProperties[] = "'dismiss_stale_reviews' can't be null";
        }
        if ($this->container['require_code_owner_reviews'] === null) {
            $invalidProperties[] = "'require_code_owner_reviews' can't be null";
        }
        if (!is_null($this->container['required_approving_review_count']) && ($this->container['required_approving_review_count'] > 6)) {
            $invalidProperties[] = "invalid value for 'required_approving_review_count', must be smaller than or equal to 6.";
        }

        if (!is_null($this->container['required_approving_review_count']) && ($this->container['required_approving_review_count'] < 0)) {
     ...
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\ProtectedBranchPullRequestReviewDismissalRestrictions|null
     */
     ...
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\ProtectedBranchPullRequestReviewDismissalRestrictions|null $dismissal_restrictions dismissal_restrictions
     *
     * @return self
     */
     ...
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\ProtectedBranchPullRequestReviewBypassPullRequestAllowances|null
     */
     ...
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\ProtectedBranchPullRequestReviewBypassPullRequestAllowances|null $bypass_pull_request_allowances bypass_pull_request_allowances
     *
     * @return self
     */
     ...
     *
     * @param bool $dismiss_stale_reviews dismiss_stale_reviews
     *
     * @return self
     */
     ...
     *
     * @param bool $require_code_owner_reviews require_code_owner_reviews
     *
     * @return self
     */
     ...
     *
     * @param int|null $required_approving_review_count required_approving_review_count
     *
     * @return self
     */
    public function setRequiredApprovingReviewCount($required_approving_review_count)
    {
        ...
        if (($required_approving_review_count > 6)) {
            throw new \InvalidArgumentException('invalid value for $required_approving_review_count when calling ProtectedBranchPullRequestReview., must be smaller than or equal to 6.');
        }
        if (($required_approving_review_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $required_approving_review_count when calling ProtectedBranchPullRequestReview., must be bigger than or equal to 0.');
        }
