...
/**
 * PullRequestReview Class Doc Comment
 *
 * @category Class
 ...
 */
class PullRequestReview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pull-request-review';
    ...
    */
     ...
     * Sets commit_id
     *
     * @param string $commit_id A commit SHA for the review. If the commit object was garbage collected or forcibly deleted, then it no longer exists in Git and this value will be `null`.
     *
     * @return self
     */
