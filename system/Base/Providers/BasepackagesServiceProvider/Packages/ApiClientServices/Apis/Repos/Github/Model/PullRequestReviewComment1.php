...
/**
 * PullRequestReviewComment1 Class Doc Comment
 *
 * @category Class
 ...
 */
class PullRequestReviewComment1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pull_Request_Review_Comment_1';
    ...
    */
    ...
    public function setOriginalLine($original_line)
    {
        if (is_null($original_line)) {
            array_push($this->openAPINullablesSetToNull, 'original_line');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('original_line', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
