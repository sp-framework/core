...
/**
 * PullsMergeRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class PullsMergeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pulls_merge_request';
    ...
    */
     ...
     * Sets commit_title
     *
     * @param string|null $commit_title Title for the automatic commit message.
     *
     * @return self
     */
     ...
     * Sets commit_message
     *
     * @param string|null $commit_message Extra detail to append to automatic commit message.
     *
     * @return self
     */
     ...
     * Sets sha
     *
     * @param string|null $sha SHA that pull request head must match to allow merge.
     *
     * @return self
     */
     ...
     * Sets merge_method
     *
     * @param string|null $merge_method The merge method to use.
     *
     * @return self
     */
