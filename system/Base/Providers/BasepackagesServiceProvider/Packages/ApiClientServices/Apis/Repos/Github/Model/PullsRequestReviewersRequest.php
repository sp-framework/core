...
/**
 * PullsRequestReviewersRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class PullsRequestReviewersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pulls_request_reviewers_request';
    ...
    */
     ...
     * Sets reviewers
     *
     * @param string[]|null $reviewers An array of user `login`s that will be requested.
     *
     * @return self
     */
     ...
     * Sets team_reviewers
     *
     * @param string[]|null $team_reviewers An array of team `slug`s that will be requested.
     *
     * @return self
     */
