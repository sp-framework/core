...
/**
 * PullsUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class PullsUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pulls_update_request';
    ...
    */
     ...
     * Sets title
     *
     * @param string|null $title The title of the pull request.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state State of this Pull Request. Either `open` or `closed`.
     *
     * @return self
     */
     ...
     * Sets base
     *
     * @param string|null $base The name of the branch you want your changes pulled into. This should be an existing branch on the current repository. You cannot update the base branch on a pull request to point to another repository.
     *
     * @return self
     */
