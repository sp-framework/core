...
/**
 * ReposCreateDeploymentProtectionRuleRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ReposCreateDeploymentProtectionRuleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repos_create_deployment_protection_rule_request';
    ...
    */
     ...
     * Sets integration_id
     *
     * @param int|null $integration_id The ID of the custom app that will be enabled on the environment.
     *
     * @return self
     */
