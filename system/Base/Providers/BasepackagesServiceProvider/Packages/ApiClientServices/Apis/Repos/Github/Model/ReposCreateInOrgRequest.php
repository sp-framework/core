...
/**
 * ReposCreateInOrgRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ReposCreateInOrgRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repos_create_in_org_request';
    ...
    */
     ...
     * Sets auto_init
     *
     * @param bool|null $auto_init Pass `true` to create an initial commit with empty README.
     *
     * @return self
     */
     ...
     *
     * @param string|null $gitignore_template Desired language or platform [.gitignore template](https://github.com/github/gitignore) to apply. Use the name of the template without the extension. For example, \"Haskell\".
     *
     * @return self
     */
     ...
     *
     * @param bool|null $delete_branch_on_merge Either `true` to allow automatically deleting head branches when pull requests are merged, or `false` to prevent automatic deletion. **The authenticated user must be an organization owner to set this property to `true`.**
     *
     * @return self
     */
     ...
     *
     * @param array<string,mixed>|null $custom_properties The custom properties for the new repository. The keys are the custom property names, and the values are the corresponding custom property values.
     *
     * @return self
     */
