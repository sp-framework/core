...
/**
 * ReposListCacheInfo200ResponseInnerGit Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ReposListCacheInfo200ResponseInnerGit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repos_list_cache_info_200_response_inner_git';
    ...
    public const SYNC_STATUS_OFFLINE = 'offline';
    public const SYNC_STATUS_INACTIVE = 'inactive';
    public const SYNC_STATUS_IN_SYNC = 'in_sync';
    public const SYNC_STATUS_NOT_IN_SYNC = 'not_in_sync';
    ...
    {
        return [
            self::SYNC_STATUS_OFFLINE,
            self::SYNC_STATUS_INACTIVE,
            self::SYNC_STATUS_IN_SYNC,
            self::SYNC_STATUS_NOT_IN_SYNC,
        ];
    }
