...
/**
 * ReposTransferRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ReposTransferRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repos_transfer_request';
    ...
    */
     ...
     * Sets new_owner
     *
     * @param string $new_owner The username or organization name the repository will be transferred to.
     *
     * @return self
     */
     ...
     * Sets new_name
     *
     * @param string|null $new_name The new name to be given to the repository.
     *
     * @return self
     */
