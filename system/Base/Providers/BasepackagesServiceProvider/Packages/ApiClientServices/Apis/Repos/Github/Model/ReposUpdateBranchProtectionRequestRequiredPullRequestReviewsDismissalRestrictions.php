...
/**
 * ReposUpdateBranchProtectionRequestRequiredPullRequestReviewsDismissalRestrictions Class Doc Comment
 *
 * @category Class
 ...
 */
class ReposUpdateBranchProtectionRequestRequiredPullRequestReviewsDismissalRestrictions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repos_update_branch_protection_request_required_pull_request_reviews_dismissal_restrictions';
    ...
    */
     ...
     * Sets users
     *
     * @param string[]|null $users The list of user `login`s with dismissal access
     *
     * @return self
     */
     ...
     * Sets teams
     *
     * @param string[]|null $teams The list of team `slug`s with dismissal access
     *
     * @return self
     */
     ...
     * Sets apps
     *
     * @param string[]|null $apps The list of app `slug`s with dismissal access
     *
     * @return self
     */
