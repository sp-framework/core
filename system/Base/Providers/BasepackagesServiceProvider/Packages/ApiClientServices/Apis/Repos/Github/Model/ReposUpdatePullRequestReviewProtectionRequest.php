...
/**
 * ReposUpdatePullRequestReviewProtectionRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class ReposUpdatePullRequestReviewProtectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repos_update_pull_request_review_protection_request';
    ...
    */
     ...
     *
     * @param int|null $required_approving_review_count Specifies the number of reviewers required to approve pull requests. Use a number between 1 and 6 or 0 to not require reviewers.
     *
     * @return self
     */
