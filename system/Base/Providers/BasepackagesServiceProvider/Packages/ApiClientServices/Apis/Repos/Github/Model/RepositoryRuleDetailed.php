...
/**
 * RepositoryRuleDetailed Class Doc Comment
 *
 * @category Class
 ...
 */
class RepositoryRuleDetailed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repository-rule-detailed';
    ...
    public const TYPE_REQUIRED_LINEAR_HISTORY = 'required_linear_history';
    public const TYPE_REQUIRED_DEPLOYMENTS = 'required_deployments';
    public const TYPE_REQUIRED_SIGNATURES = 'required_signatures';
    public const TYPE_PULL_REQUEST = 'pull_request';
    public const TYPE_REQUIRED_STATUS_CHECKS = 'required_status_checks';
    public const TYPE_NON_FAST_FORWARD = 'non_fast_forward';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_UPDATE,
            self::TYPE_DELETION,
            self::TYPE_REQUIRED_LINEAR_HISTORY,
            self::TYPE_REQUIRED_DEPLOYMENTS,
            self::TYPE_REQUIRED_SIGNATURES,
            self::TYPE_PULL_REQUEST,
            self::TYPE_REQUIRED_STATUS_CHECKS,
            self::TYPE_NON_FAST_FORWARD,
