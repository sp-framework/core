...
/**
 * RepositoryRuleParamsStatusCheckConfiguration Class Doc Comment
 *
 * @category Class
 ...
 */
class RepositoryRuleParamsStatusCheckConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repository-rule-params-status-check-configuration';
    ...
    */
     ...
     * Sets context
     *
     * @param string $context The status check context name that must be present on the commit.
     *
     * @return self
     */
     ...
     * Sets integration_id
     *
     * @param int|null $integration_id The optional integration ID that this status check must originate from.
     *
     * @return self
     */
