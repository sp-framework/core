...
/**
 * RepositoryRuleParamsWorkflowFileReference Class Doc Comment
 *
 * @category Class
 ...
 */
class RepositoryRuleParamsWorkflowFileReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repository-rule-params-workflow-file-reference';
    ...
    */
     ...
     * Sets path
     *
     * @param string $path The path to the workflow file
     *
     * @return self
     */
     ...
     * Sets ref
     *
     * @param string|null $ref The ref (branch or tag) of the workflow file to use
     *
     * @return self
     */
     ...
     * Sets repository_id
     *
     * @param int $repository_id The ID of the repository where the workflow is defined
     *
     * @return self
     */
     ...
     * Sets sha
     *
     * @param string|null $sha The commit SHA of the workflow file to use
     *
     * @return self
     */
