...
/**
 * RepositorySubscription Class Doc Comment
 *
 * @category Class
 ...
 */
class RepositorySubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repository-subscription';
    ...
    */
     ...
     * Sets subscribed
     *
     * @param bool $subscribed Determines if notifications should be received from this repository.
     *
     * @return self
     */
     ...
     * Sets ignored
     *
     * @param bool $ignored Determines if all notifications should be blocked from this repository.
     *
     * @return self
     */
