...
/**
 * RunnerGroupsOrg Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class RunnerGroupsOrg implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'runner-groups-org';
    ...
    protected static $setters = [
        ...
        'inherited_allows_public_repositories' => 'setInheritedAllowsPublicRepositories',
    ...
    protected static $getters = [
        ...
        'inherited_allows_public_repositories' => 'getInheritedAllowsPublicRepositories',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('inherited_allows_public_repositories', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $selected_repositories_url Link to the selected repositories resource for this runner group. Not present unless visibility was set to `selected`
     *
     * @return self
     */
    ...
    /**
     * Gets inherited_allows_public_repositories
     *
     * @return bool|null
     */
    public function getInheritedAllowsPublicRepositories()
    {
        return $this->container['inherited_allows_public_repositories'];
    }

    /**
     * Sets inherited_allows_public_repositories
     *
     * @param bool|null $inherited_allows_public_repositories inherited_allows_public_repositories
     *
     * @return self
     */
    public function setInheritedAllowsPublicRepositories($inherited_allows_public_repositories)
    {
        if (is_null($inherited_allows_public_repositories)) {
            throw new \InvalidArgumentException('non-nullable inherited_allows_public_repositories cannot be null');
        }
        $this->container['inherited_allows_public_repositories'] = $inherited_allows_public_repositories;
