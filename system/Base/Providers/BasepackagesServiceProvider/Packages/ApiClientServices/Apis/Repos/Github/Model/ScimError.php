 ...
 */
class ScimError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'scim-error';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('scim_type', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['scim_type'];
    }

    /**
     * Sets scim_type
     *
     * @param string|null $scim_type scim_type
     *
     * @return self
     */
    public function setScimType($scim_type)
    {
        if (is_null($scim_type)) {
            array_push($this->openAPINullablesSetToNull, 'scim_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('scim_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['scim_type'] = $scim_type;
