<?php
/**
 * SecretScanningPatchSecurityAnalysisSettingsForEnterpriseRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SecretScanningPatchSecurityAnalysisSettingsForEnterpriseRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class SecretScanningPatchSecurityAnalysisSettingsForEnterpriseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'secret_scanning_patch_security_analysis_settings_for_enterprise_request';
    ...
    */
     ...
     *
     * @param bool|null $dependabot_alerts_enabled_for_new_repositories Whether Dependabot alerts are automatically enabled for new repositories. For more information, see \"[About Dependabot alerts](https://docs.github.com/enterprise-server@3.12/code-security/dependabot/dependabot-alerts/about-dependabot-alerts).\"
     *
     * @return self
     */
     ...
     *
     * @param bool|null $secret_scanning_enabled_for_new_repositories Whether secret scanning is automatically enabled for new repositories. For more information, see \"[About secret scanning](https://docs.github.com/enterprise-server@3.12/code-security/secret-scanning/about-secret-scanning).\"
     *
     * @return self
     */
     ...
     *
     * @param string|null $secret_scanning_push_protection_custom_link The URL that will be displayed to contributors who are blocked from pushing a secret. For more information, see \"[Protecting pushes with secret scanning](https://docs.github.com/enterprise-server@3.12/code-security/secret-scanning/protecting-pushes-with-secret-scanning).\" To disable this functionality, set this field to `null`.
     *
     * @return self
     */
