...
/**
 * SelectedActions Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class SelectedActions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'selected-actions';
    ...
    */
    ...
    {
        return $this->container['github_owned_allowed'];
    }
     ...
     * @return self
     */
    public function setGithubOwnedAllowed($github_owned_allowed)
    {
        if (is_null($github_owned_allowed)) {
            throw new \InvalidArgumentException('non-nullable github_owned_allowed cannot be null');
        }
        $this->container['github_owned_allowed'] = $github_owned_allowed;
    ...
    {
        return $this->container['patterns_allowed'];
    }
     ...
     * @return self
     */
    public function setPatternsAllowed($patterns_allowed)
    {
        if (is_null($patterns_allowed)) {
            throw new \InvalidArgumentException('non-nullable patterns_allowed cannot be null');
        }
        $this->container['patterns_allowed'] = $patterns_allowed;
