...
/**
 * TeamDiscussionComment Class Doc Comment
 *
 * @category Class
 ...
 */
class TeamDiscussionComment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'team-discussion-comment';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['discussion_url'] === null) {
            $invalidProperties[] = "'discussion_url' can't be null";
        }
     ...
     * Sets body
     *
     * @param string $body The main text of the comment.
     *
     * @return self
     */
     ...
     * Sets discussion_url
     *
     * @param string $discussion_url discussion_url
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param int $number The unique sequence number of a team discussion comment.
     *
     * @return self
     */
