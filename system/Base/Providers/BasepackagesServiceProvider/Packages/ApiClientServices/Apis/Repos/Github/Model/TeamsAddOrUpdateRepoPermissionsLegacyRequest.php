...
/**
 * TeamsAddOrUpdateRepoPermissionsLegacyRequest Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class TeamsAddOrUpdateRepoPermissionsLegacyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'teams_add_or_update_repo_permissions_legacy_request';
    ...
    */
     ...
     * Sets permission
     *
     * @param string|null $permission The permission to grant the team on this repository. If no permission is specified, the team's `permission` attribute will be used to determine what permission to grant the team on this repository.
     *
     * @return self
     */
