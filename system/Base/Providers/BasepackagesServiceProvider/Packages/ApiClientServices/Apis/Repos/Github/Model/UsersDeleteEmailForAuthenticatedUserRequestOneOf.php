...
/**
 * UsersDeleteEmailForAuthenticatedUserRequestOneOf Class Doc Comment
 *
 * @category Class
 ...
 */
class UsersDeleteEmailForAuthenticatedUserRequestOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'users_delete_email_for_authenticated_user_request_oneOf';
    ...
    */
     ...
     * Sets emails
     *
     * @param string[] $emails Email addresses associated with the GitHub user account.
     *
     * @return self
     */
