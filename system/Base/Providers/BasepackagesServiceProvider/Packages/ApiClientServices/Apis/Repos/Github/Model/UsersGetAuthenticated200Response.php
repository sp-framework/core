...
/**
 * UsersGetAuthenticated200Response Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class UsersGetAuthenticated200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'users_get_authenticated_200_response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('two_factor_authentication', $data ?? [], null);
        $this->setIfExists('plan', $data ?? [], null);
        $this->setIfExists('suspended_at', $data ?? [], null);
        $this->setIfExists('business_plus', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['blog'] === null) {
            $invalidProperties[] = "'blog' can't be null";
        }
        ...
        if ($this->container['hireable'] === null) {
            $invalidProperties[] = "'hireable' can't be null";
        }
        ...
        if ($this->container['total_private_repos'] === null) {
            $invalidProperties[] = "'total_private_repos' can't be null";
        }
        if ($this->container['owned_private_repos'] === null) {
            $invalidProperties[] = "'owned_private_repos' can't be null";
        }
        if ($this->container['disk_usage'] === null) {
            $invalidProperties[] = "'disk_usage' can't be null";
        }
        if ($this->container['collaborators'] === null) {
            $invalidProperties[] = "'collaborators' can't be null";
        }
        if ($this->container['two_factor_authentication'] === null) {
            $invalidProperties[] = "'two_factor_authentication' can't be null";
        }
     ...
     *
     * @param int $total_private_repos total_private_repos
     *
     * @return self
     */
     ...
     *
     * @param int $owned_private_repos owned_private_repos
     *
     * @return self
     */
     ...
     *
     * @param bool $two_factor_authentication two_factor_authentication
     *
     * @return self
     */
    public function setTwoFactorAuthentication($two_factor_authentication)
    {
        if (is_null($two_factor_authentication)) {
            throw new \InvalidArgumentException('non-nullable two_factor_authentication cannot be null');
        }
     ...
     * @return bool|null
     */
    public function getBusinessPlus()
    {
        return $this->container['business_plus'];
    }

    /**
     * Sets business_plus
     *
     * @param bool|null $business_plus business_plus
     *
     * @return self
     */
    public function setBusinessPlus($business_plus)
    {
        if (is_null($business_plus)) {
            throw new \InvalidArgumentException('non-nullable business_plus cannot be null');
        }
        $this->container['business_plus'] = $business_plus;
     ...
     * Sets ldap_dn
     *
     * @param string|null $ldap_dn ldap_dn
     *
     * @return self
     */
