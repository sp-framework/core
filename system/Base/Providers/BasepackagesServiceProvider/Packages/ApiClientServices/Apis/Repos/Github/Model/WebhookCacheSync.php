...
/**
 * WebhookCacheSync Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class WebhookCacheSync implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook-cache-sync';
    ...
    protected static $setters = [
        'after' => 'setAfter',
        'before' => 'setBefore',
        'cache_location' => 'setCacheLocation',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cache_location', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cache_location'] === null) {
            $invalidProperties[] = "'cache_location' can't be null";
        }
    ...
    {
        return $this->container['cache_location'];
    }

    /**
     * Sets cache_location
     *
     * @param string $cache_location cache_location
     *
     * @return self
     */
    public function setCacheLocation($cache_location)
    {
        if (is_null($cache_location)) {
            throw new \InvalidArgumentException('non-nullable cache_location cannot be null');
        }
        $this->container['cache_location'] = $cache_location;
