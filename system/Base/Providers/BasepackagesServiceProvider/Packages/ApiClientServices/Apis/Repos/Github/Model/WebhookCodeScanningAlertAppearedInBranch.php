...
/**
 * WebhookCodeScanningAlertAppearedInBranch Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class WebhookCodeScanningAlertAppearedInBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook-code-scanning-alert-appeared-in-branch';
    ...
    protected static $openAPITypes = [
        'action' => 'string',
        'alert' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookCodeScanningAlertAppearedInBranchAlert',
        'commit_oid' => 'string',
    ...
    public const ACTION_APPEARED_IN_BRANCH = 'appeared_in_branch';
    ...
    {
        return [
            self::ACTION_APPEARED_IN_BRANCH,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['commit_oid'] === null) {
            $invalidProperties[] = "'commit_oid' can't be null";
        }
     ...
     * Gets alert
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookCodeScanningAlertAppearedInBranchAlert
     */
     ...
     * Sets alert
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookCodeScanningAlertAppearedInBranchAlert $alert alert
     *
     * @return self
     */
     ...
     * Sets commit_oid
     *
     * @param string $commit_oid The commit SHA of the code scanning alert. When the action is `reopened_by_user` or `closed_by_user`, the event was triggered by the `sender` and this value will be empty.
     *
     * @return self
     */
     ...
     * Sets ref
     *
     * @param string $ref The Git reference of the code scanning alert. When the action is `reopened_by_user` or `closed_by_user`, the event was triggered by the `sender` and this value will be empty.
     *
     * @return self
     */
