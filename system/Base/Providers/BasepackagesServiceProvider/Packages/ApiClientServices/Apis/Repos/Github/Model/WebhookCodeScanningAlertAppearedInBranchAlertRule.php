...
/**
 * WebhookCodeScanningAlertAppearedInBranchAlertRule Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class WebhookCodeScanningAlertAppearedInBranchAlertRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook_code_scanning_alert_appeared_in_branch_alert_rule';
    ...
    public const SEVERITY_NULL = 'null';
    ...
    */
     ...
     * Sets description
     *
     * @param string $description A short description of the rule used to detect the alert.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id A unique identifier for the rule used to detect the alert.
     *
     * @return self
     */
