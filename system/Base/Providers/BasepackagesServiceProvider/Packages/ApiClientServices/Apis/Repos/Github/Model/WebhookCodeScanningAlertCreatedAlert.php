...
/**
 * WebhookCodeScanningAlertCreatedAlert Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookCodeScanningAlertCreatedAlert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook_code_scanning_alert_created_alert';
    ...
    protected static $openAPITypes = [
        ...
        'state' => 'string',
        'tool' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookCodeScanningAlertCreatedAlertTool',
        'updated_at' => 'string',
        'url' => 'string'
    ];
    ...
    */
     ...
     * Sets dismissed_at
     *
     * @param mixed $dismissed_at The time that the alert was dismissed in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`.
     *
     * @return self
     */
     ...
     * Sets dismissed_by
     *
     * @param mixed $dismissed_by dismissed_by
     *
     * @return self
     */
    ...
    public function setDismissedComment($dismissed_comment)
    {
        ...
        if (!is_null($dismissed_comment) && (mb_strlen($dismissed_comment) > 280)) {
            throw new \InvalidArgumentException('invalid length for $dismissed_comment when calling WebhookCodeScanningAlertCreatedAlert., must be smaller than or equal to 280.');
        }
     ...
     *
     * @param mixed $dismissed_reason The reason for dismissing or closing the alert. Can be one of: `false positive`, `won't fix`, and `used in tests`.
     *
     * @return self
     */
     ...
     * Sets fixed_at
     *
     * @param mixed|null $fixed_at fixed_at
     *
     * @return self
     */
     ...
     * Gets tool
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookCodeScanningAlertCreatedAlertTool
     */
     ...
     * Sets tool
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookCodeScanningAlertCreatedAlertTool $tool tool
     *
     * @return self
     */
    ...
    {
        if (is_null($tool)) {
            array_push($this->openAPINullablesSetToNull, 'tool');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tool', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
