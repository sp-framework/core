...
/**
 * WebhookCodeScanningAlertReopenedAlert Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookCodeScanningAlertReopenedAlert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook_code_scanning_alert_reopened_alert';
    ...
    */
     ...
     * Sets dismissed_at
     *
     * @param string $dismissed_at The time that the alert was dismissed in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`.
     *
     * @return self
     */
     ...
     *
     * @param string $dismissed_reason The reason for dismissing or closing the alert. Can be one of: `false positive`, `won't fix`, and `used in tests`.
     *
     * @return self
     */
