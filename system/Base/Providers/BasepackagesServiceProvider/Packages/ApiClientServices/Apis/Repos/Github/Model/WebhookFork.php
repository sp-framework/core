 ...
 */
class WebhookFork implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook-fork';
    ...
    protected static $openAPITypes = [
        ...
        'forkee' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookForkForkee',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['forkee'] === null) {
            $invalidProperties[] = "'forkee' can't be null";
        }
     ...
     * Gets forkee
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookForkForkee
     */
     ...
     * Sets forkee
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookForkForkee $forkee forkee
     *
     * @return self
     */
    public function setForkee($forkee)
    {
        if (is_null($forkee)) {
            throw new \InvalidArgumentException('non-nullable forkee cannot be null');
        }
