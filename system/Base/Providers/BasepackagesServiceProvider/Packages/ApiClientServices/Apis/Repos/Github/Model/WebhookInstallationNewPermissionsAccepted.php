...
/**
 * WebhookInstallationNewPermissionsAccepted Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class WebhookInstallationNewPermissionsAccepted implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook-installation-new-permissions-accepted';
    ...
    public const ACTION_NEW_PERMISSIONS_ACCEPTED = 'new_permissions_accepted';
    ...
    {
        return [
            self::ACTION_NEW_PERMISSIONS_ACCEPTED,
        ];
    }
    ...
    */
     ...
     * Sets requester
     *
     * @param mixed|null $requester requester
     *
     * @return self
     */
