...
/**
 * WebhookPullRequestConvertedToDraft Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class WebhookPullRequestConvertedToDraft implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook-pull-request-converted-to-draft';
    ...
    public const ACTION_CONVERTED_TO_DRAFT = 'converted_to_draft';
    ...
    {
        return [
            self::ACTION_CONVERTED_TO_DRAFT,
        ];
    }
