...
/**
 * WebhookRegistryPackagePublishedRegistryPackagePackageVersion Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class WebhookRegistryPackagePublishedRegistryPackagePackageVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook_registry_package_published_registry_package_package_version';
    ...
    protected static $openAPITypes = [
        ...
        'body' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookPackagePublishedPackagePackageVersionBody',
        'body_html' => 'string',
        'container_metadata' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionContainerMetadata',
        'created_at' => 'string',
        'description' => 'string',
        ...
        'name' => 'string',
        'npm_metadata' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata',
        'nuget_metadata' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadataInner[]',
        'package_files' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionPackageFilesInner[]',
        'package_url' => 'string',
        'prerelease' => 'bool',
        'release' => '\System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionRelease',
    ...
    protected static $setters = [
        ...
        'container_metadata' => 'setContainerMetadata',
        ...
        'name' => 'setName',
        'npm_metadata' => 'setNpmMetadata',
        'nuget_metadata' => 'setNugetMetadata',
    ...
    protected static $getters = [
        ...
        'container_metadata' => 'getContainerMetadata',
        ...
        'name' => 'getName',
        'npm_metadata' => 'getNpmMetadata',
        'nuget_metadata' => 'getNugetMetadata',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('container_metadata', $data ?? [], null);
        ...
        $this->setIfExists('npm_metadata', $data ?? [], null);
        $this->setIfExists('nuget_metadata', $data ?? [], null);
    ...
    */
     ...
     * Gets author
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackageOwner|null
     */
     ...
     * Sets author
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackageOwner|null $author author
     *
     * @return self
     */
     ...
     * Gets body
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookPackagePublishedPackagePackageVersionBody|null
     */
     ...
     * Sets body
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookPackagePublishedPackagePackageVersionBody|null $body body
     *
     * @return self
     */
    ...
    /**
     * Gets container_metadata
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionContainerMetadata|null
     */
    public function getContainerMetadata()
    {
        return $this->container['container_metadata'];
    }

    /**
     * Sets container_metadata
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionContainerMetadata|null $container_metadata container_metadata
     *
     * @return self
     */
    public function setContainerMetadata($container_metadata)
    {
        if (is_null($container_metadata)) {
            throw new \InvalidArgumentException('non-nullable container_metadata cannot be null');
        }
        $this->container['container_metadata'] = $container_metadata;
     ...
     * Gets npm_metadata
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata|null
     */
    public function getNpmMetadata()
    {
        return $this->container['npm_metadata'];
    }

    /**
     * Sets npm_metadata
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata|null $npm_metadata npm_metadata
     *
     * @return self
     */
    public function setNpmMetadata($npm_metadata)
    {
        if (is_null($npm_metadata)) {
            array_push($this->openAPINullablesSetToNull, 'npm_metadata');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('npm_metadata', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['npm_metadata'] = $npm_metadata;
     ...
     * Gets nuget_metadata
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadataInner[]|null
     */
    public function getNugetMetadata()
    {
        return $this->container['nuget_metadata'];
    }

    /**
     * Sets nuget_metadata
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadataInner[]|null $nuget_metadata nuget_metadata
     *
     * @return self
     */
    public function setNugetMetadata($nuget_metadata)
    {
        if (is_null($nuget_metadata)) {
            array_push($this->openAPINullablesSetToNull, 'nuget_metadata');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('nuget_metadata', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['nuget_metadata'] = $nuget_metadata;
     ...
     * Gets package_files
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionPackageFilesInner[]
     */
     ...
     * Sets package_files
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionPackageFilesInner[] $package_files package_files
     *
     * @return self
     */
     ...
     * Gets release
     *
     * @return \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionRelease|null
     */
     ...
     * Sets release
     *
     * @param \System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github\Model\WebhookRegistryPackagePublishedRegistryPackagePackageVersionRelease|null $release release
     *
     * @return self
     */
     ...
     * Sets target_oid
     *
     * @param string|null $target_oid target_oid
     *
     * @return self
     */
