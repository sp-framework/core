...
/**
 * WebhookRepositoryDispatchSample Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class WebhookRepositoryDispatchSample implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook-repository-dispatch-sample';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['client_payload'] === null) {
            $invalidProperties[] = "'client_payload' can't be null";
        }
     ...
     * Sets action
     *
     * @param string $action The `event_type` that was specified in the `POST /repos/{owner}/{repo}/dispatches` request body.
     *
     * @return self
     */
     ...
     * Sets client_payload
     *
     * @param array<string,mixed> $client_payload The `client_payload` that was specified in the `POST /repos/{owner}/{repo}/dispatches` request body.
     *
     * @return self
     */
    public function setClientPayload($client_payload)
    {
        if (is_null($client_payload)) {
            array_push($this->openAPINullablesSetToNull, 'client_payload');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('client_payload', $nullablesSetToNull);
            if ($index !== FALSE) {
