...
/**
 * WebhookStarCreated Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class WebhookStarCreated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhook-star-created';
    ...
    */
     ...
     * Sets starred_at
     *
     * @param string $starred_at The time the star was created. This is a timestamp in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`. Will be `null` for the `deleted` action.
     *
     * @return self
     */
    public function setStarredAt($starred_at)
    {
        if (is_null($starred_at)) {
            array_push($this->openAPINullablesSetToNull, 'starred_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('starred_at', $nullablesSetToNull);
            if ($index !== FALSE) {
