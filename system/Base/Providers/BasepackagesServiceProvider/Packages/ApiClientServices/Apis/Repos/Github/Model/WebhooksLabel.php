...
/**
 * WebhooksLabel Class Doc Comment
 *
 * @category Class
 * @package  System\Base\Providers\BasepackagesServiceProvider\Packages\ApiClientServices\Apis\Repos\Github
 * @author   OpenAPI Generator team
 ...
 */
class WebhooksLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhooks_label';
    ...
    */
     ...
     * Sets color
     *
     * @param string $color 6-character hex code, without the leading #, identifying the color
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url URL for the label
     *
     * @return self
     */
