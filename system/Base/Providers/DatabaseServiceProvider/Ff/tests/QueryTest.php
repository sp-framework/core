...
final class QueryTest extends SleekDBTestCase
{
  ...
  public function testCanGetResultWithWhere(){
    ...
    $users = $userQueryBuilder->where(["id", "=", 1])->getQuery()->fetch();
  ...
  public function testCanGetResultWithOrWhere(){
    ...
    $users = $userQueryBuilder->where(["id", "=", 1])->orWhere(["id", "=", 2])->getQuery()->fetch();
  ...
  public function testCanGetResultWithAndConditionBetweenOrWhere(){
    ...
    $users = $userQueryBuilder->where(["id", "=", 1])->orWhere([["id", "=", 2], ["id", "=", 3]])->getQuery()->fetch();
  ...
  public function testCanGetResultWithMultipleWhere(){
    ...
    $users = $userQueryBuilder->where(["id", "=", 1])->where(["id", "=", 2])->getQuery()->fetch();
  ...
  public function testCanGetResultWithoutSomeFields(){
    ...
    $users = $userQueryBuilder->except(["id", "name"])->where(["id", "=", 1])->getQuery()->fetch();

    foreach ($users as $user){
      self::assertArrayNotHasKey("id", $user);
  ...
  public function testCanGetResultWithSpecificFields(){
    ...
    $users = $userQueryBuilder->select(["id", "price"])->where(["id", "=", 1])->getQuery()->fetch();
  ...
  public function testCanGetResultWithInCondition(){
    ...
    $users = $userQueryBuilder->where(["id","in",[1,2]])->getQuery()->fetch();
  ...
  public function testCanGetResultWithNotInCondition(){
    ...
    $users = $userQueryBuilder->where(["id", "not in", [1,2]])->getQuery()->fetch();
...
//  }
  ...
  public function testResultExists(){
    ...
    $userExists = $userQueryBuilder->where(["id", "=", 1])->getQuery()->exists();

    self::assertTrue($userExists);

    $userQueryBuilder = $userStore->createQueryBuilder();

    $userExists = $userQueryBuilder->where(["id", "=", 2])->where(["id", "=", 1])->getQuery()->exists();
  ...
  public function testCanUseCacheWithNoParameter(){
    ...
    $query = $userQueryBuilder->where(["id", "=", 1])->useCache()->getQuery();
  ...
  public function testCanUseCacheWithLifetimeNull(){
    ...
    $query = $userQueryBuilder->where(["id", "=", 1])->useCache(null)->getQuery();
  ...
  public function testCanUseCacheWithLifetimeZero(){
    ...
    $query = $userQueryBuilder->where(["id", "=", 1])->useCache(0)->getQuery();
  ...
  public function testCanUseCacheWithLifetimeInt(){
    ...
    $query = $userQueryBuilder->where(["id", "=", 1])->useCache(1)->getQuery();
