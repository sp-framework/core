...
use System\Base\Providers\SecurityServiceProvider\PasswordGenerator\Exception\ImpossibleMinMaxLimitsException;
use System\Base\Providers\SecurityServiceProvider\PasswordGenerator\Exception\InvalidOptionException;
 ...
 *
 * @package System\Base\Providers\SecurityServiceProvider\PasswordGenerator\Generator
 */
class RequirementPasswordGenerator extends ComputerPasswordGenerator
{
     ...
     * @throws \System\Base\Providers\SecurityServiceProvider\PasswordGenerator\Exception\CharactersNotFoundException
     */
    ...
    public function validLimits()
    {
        ...
        if ($total > $this->getLength('maximum')) {
            return false;
        }
        ...
        if ($elements <= count($this->maximumCounts)) {
            ...
            if ($total < $this->getLength('minimum')) {
                return false;
            }
        }
